...
<div style="max-width: 900px; margin: 0 auto; padding: 20px 24px 60px;">
  ...
  <p style="font-size: 14px; color: var(--muted); line-height: 1.6; margin-bottom: 24px;">
    To see how your tax code affects your monthly pay packet, enter your salary and tax code into our <a href="/full-calc" style="color: var(--teal); font-weight: 600; text-decoration: none;">Full UK Tax Calculator</a>.
  </p>
</div>
